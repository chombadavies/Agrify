...
<main class="bg_gray">
    <div class="container margin_60_35 add_bottom_30">
        <div class="main_title">
            <h2>About Scantech Technologies</h2>
<p>The best in town,outomobile services dealler</p>
        </div>
    ...
    <div class="bg_white">
        <div class="container margin_60_35">
            <div class="main_title">
                <h2>Why Choose Scantech Technologies</h2>
    ...
    <div class="owl-carousel owl-theme carousel_centered">
        <div class="item">
            <a href="#0">
                ...
                </div><img src="{{('frontend/img/staff/1_carousel.jpg')}}" alt="">
            </a>
        </div>
        <div class="item">
            <a href="#0">
                ...
                </div><img src="{{asset('frontend/img/staff/2_carousel.jpg')}}" alt="">
            </a>
        </div>
        <div class="item">
            <a href="#0">
                ...
                </div><img src="{{asset('frontend/img/staff/3_carousel.jpg')}}" alt="">
            </a>
        </div>
        <div class="item">
            <a href="#0">
