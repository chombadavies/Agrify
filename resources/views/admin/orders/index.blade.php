...
<div class="line">
            ...
            <div class="card card-success card-outline">
                ...
                <tr>
                   ...
                   <td>
                      <input type="text" name="quantity[]" id="quantity" class="form-control quantity" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"  required>
                    </td>                   
                    <td>
                      <input type="text" name="price[]" id="Unit" class="form-control unit" required readonly>
                    </td> 
                    <td>
                      <input type="text" name="discount[]" id="Unit" class="form-control unit" required >
                    </td>
                    <td>
                      <input type="text" name="total_amount[]" id="Unit" class="form-control unit" required readonly>
                    </td>
...
<br>
       ...
       <script>
        ...
        $('.add_more').on('click',function(e){
         ...
         '<td> <input type="text" name="price[]" class="form-control price" required readonly></td>' +
         '<td> <input type="text" name="discount[]" class="form-control" required id="discount"></td>' +
         '<td> <input type="text" name="total_amount[]" class="form-control unit" required id="Unit" readonly></td>' +
              ...
              $(this).parent().parent().remove();
               ...
               $('.addMoreItem').delegate('.category_id','change',function(){
                ...
                var category = tr.find('.category_id option:selected').val();
                      ...
                      {
                        alert(id);
                          var url="<?=url('/portal/getProducts')?>/"+id;
