    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-12">
            <a style="cursor:pointer;color:white" href="{{route('materials.create')}}" class="btn btn-sm btn-info"><span class="fa fa-plus"><span>Create Dissemination Material</a>
...
<script>
       ...
       $('#SystemPermisions').DataTable({
        ...
        "order": [[1, "desc" ]],
           ...
           ajax:'<?=url("/admin/fetch_materials")?>',
            columns: [
            {data: 'action', name: 'action',searchable:false,orderable:false}, 
           {data: 'title', name: 'title'},
           {data: 'valuechain', name: 'valuechain'},
