 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <a href="<?=route('projects.index')?>" class="btn btn-sm btn-info"><span class="fa fa-bars">View List </span></a>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              <form action="{{route('projects.update',$project->id)}}" method="post" enctype="multipart/form-data">@csrf
                @method('put');
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" name="title" class="form-control" id="" @error('title') is-invalid @enderror placeholder="Enter Category Name" required value="{{$project->title}}">
