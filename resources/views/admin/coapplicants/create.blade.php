        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              <form action="{{route('coapplicants.store')}}" method="post" enctype="multipart/form-data">@csrf
...
<br>
                <div class="row">
                    <div class="col-md-12" class="form-control">
                        ...
                        <textarea id="meme" name="mandate" required></textarea>
                    </div>
                </div>
                <br>
                <div class="row">
                  <div class="col-md-12" class="form-control">
                      ...
                      <textarea id="relationship" name="relationship"  required></textarea>
                  </div>
              </div>
