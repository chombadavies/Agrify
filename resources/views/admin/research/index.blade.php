    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-12">
            <a style="cursor:pointer;color:white" href="{{route('research.create')}}" class="btn btn-sm btn-info"><span class="fa fa-plus"><span>Create Research Activity</a>
